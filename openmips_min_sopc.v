...
*/
    ...
    assign ram2_CE = 0;
	 assign ram2_WE_L = 0;
	 assign ram2_OE_L = 0;
	 assign ram2datainout = 16'bz;
	 assign ram2addr = 0;
	 
//	 assign ram2_CE = ~mem_ce_i;
	 assign ram1_CE = 1;
	 assign ram1_WE_L = ~ram1_OE_L | clk;
	 assign ram1_OE_L = mem_ce_i == `ChipEnable ? mem_we_i : `WriteDisable;
	 assign ram1datainout = (mem_ce_i == `ChipEnable && mem_we_i ? mem_data_i : 16'bz);
	 assign mem_data_o = ram1datainout;
	 assign inst = ram1datainout;
	 assign ram1addr = mem_ce_i == `ChipEnable ? mem_addr_i : inst_addr;
